...
const SCREENS = {
  b2c: [
    { id:'b2c-splash',      name:'Splash',                 phase:1, purpose:'Brand moment; enter cold-start funnel.', states:['default','tap CTA'], notes:'Shown on first launch. Persist “hasSeenSplash” in local storage in real app.' },
    { id:'b2c-lang',        name:'Language',               phase:1, purpose:'Choose app locale before onboarding.', states:['default','RTL preview'], notes:'English + العربية. Drives copy direction and strings.' },
    { id:'b2c-onboarding',  name:'Onboarding (value props)', phase:1, purpose:'Explain map-first discovery and booking in 2–3 beats.', states:['step 1','step 2','step 3','skip'], notes:'Show once per install or until completed.' },
    { id:'b2c-auth',        name:'Auth — choose path',     phase:1, purpose:'Route to log in vs register.', states:['default'], notes:'No phone OTP. Email + password only on next screens.' },
    { id:'b2c-login',       name:'Log in (email)',         phase:1, purpose:'Authenticate existing user with email + password.', states:['default','invalid credentials','loading'], notes:'Supabase Auth email/password. No SMS.' },
    { id:'b2c-register',    name:'Register (email)',       phase:1, purpose:'Create account with email + password.', states:['default','weak password','email taken'], notes:'Optional verify-email flow post-MVP.' },
  ...
  b2b: [
    { id:'b2b-splash',      name:'Splash (Business)',      phase:1, purpose:'Brand moment for service-center app.', states:['default'], notes:'Mirrors B2C cold start; separate binary or flavor in production.' },
    { id:'b2b-lang',        name:'Language (Business)',    phase:1, purpose:'Locale for B2B UI.', states:['default'], notes:'English + العربية.' },
    { id:'b2b-onboarding',  name:'Onboarding (Business)',    phase:1, purpose:'Explain bookings, catalog, verification for shops.', states:['step 1','step 2','step 3','skip'], notes:'Shop-focused value props.' },
    { id:'b2b-auth',        name:'Auth — choose path',     phase:1, purpose:'Log in vs create business account.', states:['default'], notes:'Email + password only on following screens.' },
    { id:'b2b-login',       name:'Log in (Business)',      phase:1, purpose:'Existing shop owner signs in with work email.', states:['default','invalid credentials'], notes:'Supabase Auth; role shop_owner.' },
    { id:'b2b-signup',      name:'Register (Business)',     phase:1, purpose:'Create account with work email + password before business profile.', states:['default','email in use','weak password'], notes:'No phone field. Business/legal details on following onboarding steps.' },
