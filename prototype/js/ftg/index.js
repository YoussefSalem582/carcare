/* =========================================================
   Flutter Team Guide — technical handbook (single wide column)
   ========================================================= */
/**
...
/**
 * Single source: eyebrow, title, checklist items, optional architecture HTML, optional hint (maps).
 * @type {Record<string, { eyebrow: string, title: string, items: { label: string, body?: string, subs?: string[] }[], extraHtml?: string, hint?: string }>}
 */
const FTG_GUIDE = {
  'ftg-overview': {
    eyebrow: 'Start here',
  ...
  'ftg-architecture': {
    ...
    extraHtml: ftgArchitectureExtra(),
  },
...
window.buildFtgHandbookBodyHtml = buildFtgHandbookBodyHtml;
window.buildFtgHandbookAsideHtml = buildFtgHandbookAsideHtml;
